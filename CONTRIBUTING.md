...
```bash
git clone https://github.com/BlumnAI-Studio/blumnai-design-system.git
...
- **GitHub Repository**: [BlumnAI-Studio/blumnai-design-system](https://github.com/BlumnAI-Studio/blumnai-design-system)
