...
> Popover는 항상 **앵커 기준 dissolve**. 앵커가 무엇인지만 다르다.

| 앵커 유형              | 판단 기준                      | 구현                          |
|------------------------|--------------------------------|-------------------------------|
| **트리거 요소** (기본) | 클릭/호버할 버튼·요소가 있음   | Radix `PopoverTrigger`        |
| **클릭 좌표**          | 트리거 요소 없이 빈 영역 클릭  | `virtualRef` (clientX/Y)      |
