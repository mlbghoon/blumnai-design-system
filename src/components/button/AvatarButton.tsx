...
const avatarButtonVariants = cva(
  'inline-flex items-center rounded-full cursor-pointer transition-colors duration-200 focus:outline-none font-body size-sm line-height-leading-5 font-medium letter-spacing-tracking-normal',
  {
    variants: {
      buttonStyle: {
