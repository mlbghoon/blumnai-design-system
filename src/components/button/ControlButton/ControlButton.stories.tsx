  ...
  render: () => (
    <div className="flex flex-col gap-16">
      <div className="flex flex-wrap gap-12 items-center padding-16 rounded-md border-default">
        ...
        <ControlButton icon={['media', 'play']} aria-label="Play" style="default" />
        <ControlButton icon={['media', 'pause']} aria-label="Pause" style="default" />
        <ControlButton icon={['media', 'skip-forward']} aria-label="Skip" style="default" />
      </div>
      <div className="flex flex-wrap gap-12 items-center bg-subtle padding-16 rounded-md">
        ...
        <ControlButton icon={['media', 'play']} aria-label="Play" style="inverted" />
        <ControlButton icon={['media', 'pause']} aria-label="Pause" style="inverted" />
        <ControlButton icon={['media', 'skip-forward']} aria-label="Skip" style="inverted" />
      </div>
    </div>
  ),
};
  ...
  render: () => (
    <div className="flex flex-col gap-16">
      ...
      <div className="flex flex-wrap gap-12 items-center bg-subtle padding-16 rounded-md">
        <span className="text-white size-sm">Inverted:</span>
        <ControlButton icon={['media', 'play']} aria-label="Play" style="inverted" />
        <ControlButton icon={['media', 'play']} aria-label="Play" style="inverted" disabled />
      </div>
    </div>
  ),
};
