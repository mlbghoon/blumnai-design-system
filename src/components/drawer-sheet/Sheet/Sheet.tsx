...
const sheetVariants = cva(
  "fixed z-50 ds-gap-16 bg-background padding-24 shadow-modal-md transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
