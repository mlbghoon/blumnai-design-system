...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    ref={ref}
    className={cn(
      'blumnai-overlay blumnai-alert-dialog-overlay',
    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          ...
          // Radix focus trap fallback 시 브라우저 기본 outline 이 모달 전체에 그려지는 시각 버그 방지
          // (Dialog 와 동일). `outline-hidden` 은 일반 렌더는 outline 제거하되 forced-colors 모드에선 보존.
