...
const DialogContentInner = React.forwardRef<
  ...
  DialogContentProps
>(({ className, children, hideCloseButton = false, disableEscapeClose = false, disableOutsideClose = false, width, style, onEscapeKeyDown, onPointerDownOutside, onInteractOutside, ...props }, ref) => {
  const { isPending } = useDialogContext();
