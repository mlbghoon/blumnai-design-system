  ...
  return (
    <MenubarPrimitive.Portal container={container ?? contextContainer ?? undefined}>
      <MenubarPrimitive.Content
        ...
        className={cn(
          "z-50 min-w-[192px] max-h-[var(--radix-menubar-content-available-height)] overflow-y-auto overflow-x-hidden scrollbar-thin rounded-lg border-default bg-card padding-4 text-default shadow-modal-sm",
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[128px] max-h-[var(--radix-menubar-content-available-height)] overflow-y-auto overflow-x-hidden scrollbar-thin rounded-lg border-default bg-card padding-4 text-default shadow-modal-sm",
      "data-[state=open]:animate-in data-[state=closed]:animate-out",
      "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
      "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2",
