      ...
      >
        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ? "p-2 group-data-[collapsible=icon]:!w-[var(--sidebar-width-icon)] group-data-[collapsible=icon]:!p-1"
        ...
        {showRail && (
          <button
            ...
            className={cn(
              "fixed inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border sm:flex",
              side === "left"
        ...
        {showToggleButton && (
          <button
            ...
            className={cn(
              ...
              !toggleButtonOffset && toggleButtonPosition === "top" && "top-4",
              !toggleButtonOffset && toggleButtonPosition === "center" && "top-1/2 -translate-y-1/2",
              !toggleButtonOffset && toggleButtonPosition === "bottom" && "bottom-4"
            )}
...
>(({ className, position = "center", offset, icon, ...props }, ref) => {
  ...
  return (
    <button
      ...
      title="Toggle Sidebar"
      className={cn(
        "absolute -right-3 z-20 flex items-center justify-center cursor-pointer",
        "width-24 height-24 rounded-full",
        "bg-default border-default shadow-sm",
        "hover:bg-subtle transition-colors",
        "group-data-[side=right]:-left-3 group-data-[side=right]:right-auto",
...
>(({ className, orientation = "horizontal", decorative = true, ...props }, ref) => {
  return (
    <SeparatorPrimitive.Root
      ...
      className={cn(
        "mx-2 w-auto bg-sidebar-border shrink-0",
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute right-3 top-3.5 flex aspect-square width-20 items-center justify-center rounded-md padding-0 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:width-16 [&>svg]:height-16 [&>svg]:shrink-0",
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    data-sidebar="menu"
    className={cn(
      "flex w-full min-w-0 flex-col gap-4 list-none",
...
>(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute right-1 top-1.5 flex aspect-square width-20 items-center justify-center rounded-md padding-0 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 peer-hover/menu-button:text-sidebar-accent-foreground [&>svg]:width-16 [&>svg]:height-16 [&>svg]:shrink-0",
        "after:absolute after:-inset-2 after:md:hidden",
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "pointer-events-none absolute right-1 top-1.5 flex height-20 min-w-5 select-none items-center justify-center rounded-md padding-x-4 size-xs font-body font-medium line-height-leading-4 tabular-nums text-sidebar-foreground",
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    <div
      ...
      className={cn("flex height-32 items-center gap-8 rounded-md padding-x-8", className)}
      {...props}
    >
      {showIcon && (
        <Skeleton
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      "mx-3.5 flex min-w-0 translate-x-px flex-col gap-4 border-l border-sidebar-border padding-x-10 padding-y-2 list-none",
      "group-data-[collapsible=icon]:hidden",
      className
    )}
    {...props}
