  ...
  (
    ...
    if (type === 'text') {
      return (
        <div
          ...
          {...props}
        >
          <span className="flex-1 font-body size-xs line-height-leading-4 font-normal letter-spacing-tracking-normal text-muted [overflow-wrap:anywhere]">
            {text}
          </span>
        </div>
      );
    ...
    if (type === 'label') {
      return (
        ...
        >
          {label && (
            <span className="flex-1 font-body size-xs line-height-leading-4 font-medium letter-spacing-tracking-normal text-default [overflow-wrap:anywhere]">
              {label}
            </span>
          )}
          {caption && (
            <span className="font-body size-xs line-height-leading-4 font-normal letter-spacing-tracking-normal text-muted [overflow-wrap:anywhere]">
              {caption}
            </span>
          )}
        </div>
    ...
    if (type === 'item') {
      return (
        ...
        >
          ...
          {caption && (
            <span className="size-xs font-body line-height-leading-4 font-normal letter-spacing-tracking-normal text-muted [overflow-wrap:anywhere]">
              {caption}
            </span>
          )}
        </div>
